...
cd ..
rm -rf yay
yay -Syy  --noconfirm visual-studio-code-bin spotify jdk11-adoptopenjdk libreoffice jetbrains-toolbox docker nvm chromium dbeaver pencil staruml steam ntfs-3g logiops dropbox nordic-theme-git peazip-qt-bin
#filebot47 ffmpeg 
